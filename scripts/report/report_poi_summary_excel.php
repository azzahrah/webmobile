...
$headerTitle = array('POI', 'Jumlah');
$columns = array('A', 'B');
$columnsWidth = array(20, 20);
$styleArray = array(
    'borders' => array(
        'outline' => array(
...
$objPHPExcel->getActiveSheet()->setTitle('Enter-POI Report');
...
//set Border
$objPHPExcel->getActiveSheet()->getStyle('A5:B5')->getFill()
...
if ($result) {
    ...
    foreach ($response as $key => $value) {
        $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A' . $startRow, $key)
                ->setCellValue('B' . $startRow, $value);
        $startRow++;
    }
}
